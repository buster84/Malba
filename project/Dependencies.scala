...
object Dependencies {
  ...
  /*
     TODO: User should be able to choose dependencies of a database of persistance
  ...
  */
  ...
  val master = Seq(
    akkaActor, akkaRemote, akkaCluster, akkaContrib, akkaSlfj, akkaPersistence, logback, mail,
